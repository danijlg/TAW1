 ...
 * @author guzman
 */
@WebServlet(name = "ServletCustomerBorrar", urlPatterns = {"/ServletCustomerBorrar"})
public class ServletCustomerBorrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (admin == null) {
            ...
            Customer elCliente = this.customerFacade.find(new Integer(strId));        
            this.customerFacade.remove(elCliente);
